...
r  = sqrt(6) / sqrt(numClasses+hiddenSize+1); %ÎÊÌâ why there are +1 while in the multilayer-supervised not +1 -> the accuracy will not be influenced by +1, meaning add +1 or not the reslut is same.
